...
charge for ledger generation (step 3). Step 2 still cut ~10 queries, DB load, and JS
re-aggregation, and its enriched fast path is what steps 3/5 build on. The main query (1.75s)
remains step 4.
