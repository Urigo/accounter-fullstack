...
// TODO: fix this file to be the correct file types (this was copied from Cal)
...
export const discountTransactionSchema = z.object({
  trnIntId: z.string(),
...
export type DiscountTransaction = z.infer<typeof discountTransactionSchema>
