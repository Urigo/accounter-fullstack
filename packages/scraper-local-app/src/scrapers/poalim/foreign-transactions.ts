...
const PoalimForeignTransactionSchema = z.object({
  metadataAttributesOriginalEventKey: z.record(z.string(), z.any()).nullable(),
  metadataAttributesContraBranchNumber: z.record(z.string(), z.any()).nullable(),
  metadataAttributesContraAccountNumber: z.record(z.string(), z.any()).nullable(),
  metadataAttributesContraBankNumber: z.record(z.string(), z.any()).nullable(),
  metadataAttributesContraAccountFieldNameLable: z.record(z.string(), z.any()).nullable(),
  metadataAttributesDataGroupCode: z.record(z.string(), z.any()).nullable(),
  metadataAttributesCurrencyRate: z.record(z.string(), z.any()).nullable(),
  metadataAttributesContraCurrencyCode: z.record(z.string(), z.any()).nullable(),
  metadataAttributesRateFixingCode: z.record(z.string(), z.any()).nullable(),
