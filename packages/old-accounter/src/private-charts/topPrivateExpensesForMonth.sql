...
CREATE OR REPLACE FUNCTION top_private_expenses_for_month (month_input VARCHAR) RETURNS TABLE (SUM NUMERIC(9, 2), category VARCHAR) LANGUAGE SQL AS $$
...
CREATE OR REPLACE FUNCTION expenses_by_category_for_month (
  month_input VARCHAR,
