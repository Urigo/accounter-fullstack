...
import migration_2025_06_18T13_12_45_fix_poalim_swift_trigger_function from './actions/2025-06-18T13-12-45.fix-poalim-swift-trigger-function.js';
...
export const runPGMigrations = (args: { slonik: DatabasePool }) =>
  runMigrations({
    ...
    migrations: [
      ...
      migration_2025_06_18T13_12_45_fix_poalim_swift_trigger_function,
