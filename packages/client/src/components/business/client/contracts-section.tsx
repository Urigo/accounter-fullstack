    ...
    <div key={contract.id} className="rounded-lg border p-4 space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="space-y-0">
          ...
          <p className="text-sm font-medium">{standardBillingCycle(contract.billingCycle)}</p>
        </div>
        ...
        <div className="space-y-0">
          ...
          <p className="text-sm font-medium">{getDocumentNameFromType(contract.documentType)}</p>
        </div>
      </div>
