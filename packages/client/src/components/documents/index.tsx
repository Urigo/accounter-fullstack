...
import { TransactionCell } from 'packages/client/src/components/documents/transaction-cell.js';
...
import { DataTablePagination, PopUpModal, UploadDocumentsModal } from '../common/index.js';
