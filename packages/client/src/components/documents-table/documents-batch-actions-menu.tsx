...
import type { AnyTable } from '@/lib/table-features.js';
...
interface Props {
  /**
   * `AnyTable` rather than one concrete feature set: this menu is rendered from the shared select
   * column, which serves both the paginated all-documents screen and the unpaginated embedded
   * tables. Only selection APIs are used, and those exist in both sets.
   */
  table: AnyTable<DocumentsTableRowType>;
}
