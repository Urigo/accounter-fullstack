        ...
        const [securityBusiness] = await insertSecurityBusiness.run(
          {
            ...
            symbol: descriptors.symbol ?? null,
            engName: descriptors.engName ?? null,
            hebName: descriptors.hebName ?? null,
            exchange: descriptors.exchange ?? null,
            currencyCode: descriptors.currencyCode ?? null,
