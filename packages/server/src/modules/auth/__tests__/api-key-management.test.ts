...
describe('API key management', () => {
  ...
  let mockAuditProvider: { insertAuditLog: ReturnType<typeof vi.fn> };
  ...
  it('revokeApiKey soft-deletes and writes API_KEY_REVOKED audit log', async () => {
    ...
    expect(mockAuditProvider.insertAuditLog).toHaveBeenCalledWith(
  ...
  it('revokeApiKey returns false when key does not exist or already revoked', async () => {
    ...
    expect(mockAuditProvider.insertAuditLog).not.toHaveBeenCalled();
  });
