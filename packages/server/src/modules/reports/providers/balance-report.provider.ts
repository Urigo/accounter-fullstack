...
with transactions AS (SELECT
    ...
    t.currency,
    COALESCE(t.debit_date_override, t.debit_date, t.debit_timestamp::date, t.event_date) as debit_date,
    t.debit_timestamp,
    t.amount,
    t.owner_id,
    t.business_id,
    t.is_fee,
    date_part('month', COALESCE(t.debit_date_override, t.debit_date, t.debit_timestamp::date, t.event_date)) as month,
    date_part('year', COALESCE(t.debit_date_override, t.debit_date, t.debit_timestamp::date, t.event_date)) as year,
    CASE
...
LEFT JOIN LATERAL (
    ...
    WHERE er.exchange_date <= coalesce(t.debit_date_override, t.debit_date, t.debit_timestamp::date, t.event_date)
