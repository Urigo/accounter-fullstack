 ...
 *
 * Both fixtures below describe the same real-world shape: a foreign SaaS vendor issues an
 * invoice, and the subscription is paid from a USD account on a later date. The charge carries
 ...
 * other.
 *
 * The two fixtures differ only in the invoice currency, which is exactly what splits the two
...
/** Mocked exchange rates shared by both scenarios (and by the tests asserting on them). */
...
export const CURRENCY_DIFF_FOREIGN_IDS = {
...
export const currencyDiffForeignInvoiceScenario: Fixture = {
  ...
  accounts: {
    accounts: [
      createFinancialAccount({
        accountNumber: CURRENCY_DIFF_FOREIGN_IDS.accountNumber,
        type: 'BANK_ACCOUNT',
        ownerId: FOREIGN_ADMIN_ID,
      }),
    ],
  ...
  charges: {
    charges: [
      createCharge(
        ...
        {
          id: CURRENCY_DIFF_FOREIGN_IDS.chargeId,
  ...
  transactions: {
    transactions: [
      createTransaction(
        {
          charge_id: CURRENCY_DIFF_FOREIGN_IDS.chargeId,
        ...
        {
          id: CURRENCY_DIFF_FOREIGN_IDS.transactionId,
          account_id: CURRENCY_DIFF_FOREIGN_IDS.accountNumber,
  ...
  documents: {
    documents: [
      createDocument(
        ...
        {
          id: CURRENCY_DIFF_FOREIGN_IDS.documentId,
...
export const CURRENCY_DIFF_LOCAL_IDS = {
...
export const currencyDiffLocalInvoiceScenario: Fixture = {
  ...
  accounts: {
    accounts: [
      createFinancialAccount({
        accountNumber: CURRENCY_DIFF_LOCAL_IDS.accountNumber,
        type: 'BANK_ACCOUNT',
        ownerId: LOCAL_ADMIN_ID,
      }),
    ],
  ...
  charges: {
    charges: [
      createCharge(
        ...
        {
          id: CURRENCY_DIFF_LOCAL_IDS.chargeId,
          invoice_payment_currency_diff: true,
        },
      ),
    ],
  ...
  transactions: {
    transactions: [
      createTransaction(
        {
          charge_id: CURRENCY_DIFF_LOCAL_IDS.chargeId,
        ...
        {
          id: CURRENCY_DIFF_LOCAL_IDS.transactionId,
          account_id: CURRENCY_DIFF_LOCAL_IDS.accountNumber,
  ...
  documents: {
    documents: [
      createDocument(
        ...
        {
          id: CURRENCY_DIFF_LOCAL_IDS.documentId,
