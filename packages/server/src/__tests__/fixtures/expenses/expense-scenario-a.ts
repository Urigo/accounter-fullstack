...
export const expenseScenarioA: Fixture = {
  businesses: {
    businesses: [
      ...
      createBusiness({
        id: makeUUID('business', 'admin-business'),
  ...
  accounts: {
    accounts: [
      createFinancialAccount({
        ...
        type: 'BANK_ACCOUNT',
        ownerId: makeUUID('business', 'admin-business'),
      }),
    ],
  },
  ...
  charges: {
    charges: [
      createCharge(
        {
          owner_id: makeUUID('business', 'admin-business'),
      ...
      createDocument(
        {
          ...
          debtor_id: makeUUID('business', 'admin-business'), // Admin is debtor (owes money)
          type: 'RECEIPT',
