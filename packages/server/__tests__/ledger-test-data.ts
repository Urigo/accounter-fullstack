...
import { chargesModule } from 'packages/server/src/modules/charges';
import { ChargesProvider } from 'packages/server/src/modules/charges/providers/charges.provider';
import { commonModule } from 'packages/server/src/modules/common';
import { documentsModule } from 'packages/server/src/modules/documents';
import { DocumentsProvider } from 'packages/server/src/modules/documents/providers/documents.provider';
import { ExchangeProvider } from 'packages/server/src/modules/exchange-rates/providers/exchange.provider';
import { financialAccountsModule } from 'packages/server/src/modules/financial-accounts';
import { financialEntitiesModule } from 'packages/server/src/modules/financial-entities';
import { BusinessesProvider } from 'packages/server/src/modules/financial-entities/providers/businesses.provider';
import { TaxCategoriesProvider } from 'packages/server/src/modules/financial-entities/providers/tax-categories.provider';
import { ledgerModule } from 'packages/server/src/modules/ledger';
import { tagsModule } from 'packages/server/src/modules/tags';
import { TransactionsProvider } from 'packages/server/src/modules/transactions/providers/transactions.provider';
