...
- [#4398](https://github.com/Urigo/accounter-fullstack/pull/4398) [`ae6d7d2`](https://github.com/Urigo/accounter-fullstack/commit/ae6d7d285325cd3a2a1fc2aa24a5f2fcdf8c40bf) Thanks [@gilgardosh](https://github.com/gilgardosh)! - Stop sending `senderEvidence.forwardedBlocks[].date`, which the server schema has never accepted,
...
- [#4430](https://github.com/Urigo/accounter-fullstack/pull/4430) [`f23589c`](https://github.com/Urigo/accounter-fullstack/commit/f23589c9056d367bfe289d9627af2e8ddbb060c2) Thanks [@gilgardosh](https://github.com/gilgardosh)! - Stamp `X-` headers on every forwarded copy so a message in the destination mailbox can be told apart
