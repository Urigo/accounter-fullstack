    ...
    'packages/server/src/modules/': {
      ...
      config: {
        ...
        mappers: {
          ...
          BankDepositCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          BusinessTripCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          CardFinancialAccount:
            '@modules/financial-accounts/types.js#IGetFinancialAccountsByOwnerIdsResult',
          ChargeMetadata: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          CommonCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          CommonTransaction: '@modules/transactions/types.js#IGetTransactionsByIdsResult',
          ConversionCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          CreditcardBankCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          DividendCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          InternalTransferCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          MonthlyVatCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          ...
          FinancialCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
          Salary: '@modules/salaries/types.js#IGetAllSalaryRecordsResult',
          SalaryCharge: '@modules/charges/types.js#IGetMainChargesByIdsResult',
