...
export const chargeSuggestionsResolvers: ChargesModule.Resolvers = {
  Charge: {
    missingInfoSuggestions: async DbCharge => {
      if (
      ...
      if (description.includes('SLACK TAYJ1FSUA/DUBLIN')) {
        return {
          business: {
            id: '891b815f-f650-4b99-a979-caeada49bc05',
            name: 'Slack',
          },
          description: 'Slack',
          beneficiaries: [
      ...
      if (description.includes('CLOUDFLARE')) {
        return {
          business: {
            id: 'bf500365-9aef-4f87-8169-4210f6d4cdb4',
            name: 'Cloudflare, Inc.',
          },
      ...
      if (description.includes('CLICKHOUSE')) {
        return {
          business: {
            id: '8aff74ea-5fc8-4241-b700-eeacf9873977',
            name: 'ClickHouse, Inc.',
          },
      ...
      if (description.includes('WOLT')) {
        return {
          business: {
            id: '8e94b4fa-69a4-44b6-b160-af23effa1412',
            name: 'Wolt',
          },
          description: 'Wolt',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('שטראוס מים')) {
        return {
          business: {
            id: '65fc90ff-ee3a-4fe3-8aff-15ff46c2721e',
            name: 'Tami4',
          },
          description: 'Water',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('חומוס פול התימני')) {
        return {
          business: {
            id: '56c42208-a090-49fc-a0f7-bcb9dababd20',
            name: 'חומוס פול התימני',
          },
          description: 'Food',
          tags: [{ name: 'food' }],
        };
      ...
      if (description.includes('אי אם פי אם') || description.includes('איי.אם.פי.אם')) {
        return {
          business: {
            id: 'a989aab2-3677-406d-9477-b5053393c357',
            name: 'AmPm',
          },
      ...
      if (description.includes('סופר יודה')) {
        return {
          business: {
            id: '645f1069-f1bd-45d4-bfac-d7462ed38344',
            name: 'סופר יודה',
          },
          description: 'Groceries',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('הצרכניה-צמרת')) {
        return {
          business: {
            id: '56489617-41c6-4856-bd79-8d4a1961605d',
            name: 'הצרכניה-צמרת',
          },
          description: 'Groceries',
          tags: [{ name: 'food' }],
      ...
      if (
        ...
        return {
          business: {
            id: '8fa16264-de32-4592-bffb-64a1914318ad',
            name: 'Poalim',
          },
      ...
      if (description.includes('חשבונית ירוקה')) {
        return {
          business: {
            id: 'eff4c404-67e8-42c1-9212-022c137cf31a',
            name: 'Green Invoice',
          },
      ...
      if (description.includes('י.י. יעוץ והשקעות')) {
        return {
          business: {
            id: 'b9deb54c-ece9-483d-9c3c-b4ac7b2e516f',
            name: 'Yossi Yaron',
          },
      ...
      if (description.includes('דותן שמחה') || description.includes('שמחה דותן')) {
        ...
        return {
          business: {
            id: 'ca9d301f-f6db-40a8-a02e-7cf4b63fa2df',
            name: 'Dotan Employee',
          },
      ...
      if (description.includes('גולדשטין אורי')) {
        ...
        return {
          business: {
            id: '7843b805-3bb7-4d1c-9219-ff783100334b',
            name: 'Uri Employee',
          },
          description: `${previousMonth}/2022 Salary`,
          tags: [{ name: 'business' }],
      ...
      if (description.includes('גרדוש')) {
        ...
        return {
          business: {
            id: 'f4b591f3-d817-4e3d-9ecb-35b38d2df7ef',
            name: 'Gil Employee',
          },
          description: `${previousMonth}/2022 Salary`,
          tags: [{ name: 'business' }],
      ...
      if (description.includes('גלעד תדהר')) {
        return {
          business: {
            id: '855fd0ef-5fd1-4287-b391-db00b9f87ede',
            name: 'Gilad Employee',
          },
      ...
      if (description.includes('תובל')) {
        ...
        return {
          business: {
            id: '4420accf-da13-43b0-9aaa-3b94758598e4',
            name: 'Tuval Employee',
          },
          description: `${previousMonth}/2022 Salary`,
          tags: [{ name: 'business' }],
      ...
      if (description.includes('מנורה מבטחים פנס')) {
        ...
        return {
          business: {
            id: 'af386033-a577-4c9a-880a-d49acd15141d',
            name: 'מנורה פנסיה',
          },
      ...
      if (description.includes('פניקס אקסלנס')) {
        ...
        return {
          business: {
            id: '1453f8d1-adae-4761-851b-83799290b8d1',
            name: 'פניקס השתלמות',
          },
      ...
      if (description.includes('מיטב דש גמל ופנס')) {
        ...
        return {
          business: {
            id: '340c3552-0a15-4e22-ba03-19ae9322859c',
            name: 'איילון פנסיה',
          },
          description: `Pension ${previousMonth}/2022`,
          tags: [{ name: 'business' }],
      ...
      if (description.includes('מגדל מקפת')) {
        ...
        return {
          business: {
            id: 'fc2ea992-a2be-4f8a-a639-542a81276beb',
            name: 'מגדל פנסיה',
          },
          description: `Pension ${previousMonth}/2022`,
          tags: [{ name: 'business' }],
      ...
      if (description.includes('מגדל השתלמות')) {
        ...
        return {
          business: {
            id: '2697dae8-cbd5-4669-8e80-d0964e5c077e',
            name: 'מגדל השתלמות',
          },
          description: `Training Fund ${previousMonth}/2022`,
          tags: [{ name: 'business' }],
      ...
      //     return {
      //       business: {
      //         id: '5f1b96f7-bb4d-4e8c-91ed-7c488fef9efe',
      //         name: 'HOT',
      //       },
      ...
      if (description.includes('סלקום')) {
        return {
          business: {
            id: '2e5ed89b-5ddb-4b56-b042-804e44d4802d',
            name: 'Celcom',
          },
          description: 'Internet Provider',
          tags: [{ name: 'computer' }],
      ...
      if (description.includes('יורוקארד') || description.includes('ISRACARD')) {
        return {
          business: {
            id: '96dba127-90f4-4407-ae89-5a53afa42ca3',
            name: 'Isracard',
          },
      ...
      if (description.includes('MEETUP')) {
        return {
          business: {
            id: '44f70d97-9b89-45e6-984f-f78752ca59f3',
            name: 'Meetup',
          },
      ...
      if (description.includes('ביטוח לאומי')) {
        ...
        return {
          business: {
            id: '6d4b01dd-5a5e-4a43-8e40-e9dadfcc10fa',
            name: 'Social Security Deductions',
          },
      ...
      if (description.includes('HOT MOBILE')) {
        return {
          business: {
            id: 'a3cd6995-b487-49f7-be5d-bab32923037a',
            name: 'Hot Mobile',
          },
      ...
      if (description.includes('GITHUB')) {
        const suggested = {
          business: {
            id: 'af23ab30-5cf9-4433-abe1-14ae70ab64d7',
            name: 'GitHub, Inc',
          },
      ...
      if (description.includes('גילדה למוצרי תוכנה')) {
        return {
          business: {
            id: '6a20aa69-57ff-446e-8d6a-1e96d095e988',
      ...
      if (description.includes('אורי גולדשטיין בע')) {
        return {
          business: {
            id: 'a1f66c23-cea3-48a8-9a4b-0b4a0422851a',
      ...
      if (formatAmount(DbCharge.event_amount) == -4329) {
        return {
          business: {
            id: '8069311d-314e-4d1a-8f76-629757070ca0',
            name: 'Avi Peretz',
          },
      ...
      if (description.includes('פיוז אוטוטק')) {
        return {
          business: {
            id: 'd491f2bd-8ea9-4ef5-8eda-8b8c59974676',
            name: 'פיוז אוטוטק בעמ',
          },
      ...
      if (description.includes('ט.מ.ל מערכות')) {
        return {
          business: {
            id: '385215de-69ce-4da6-8173-b50def69d2ce',
            name: 'Tamal',
          },
      ...
      if (description.includes('רשם החברות')) {
        return {
          business: {
            id: '02952f36-1201-4fd3-a0ef-6cfc064e3985',
            name: 'מ.המשפטים-רשם החברות',
          },
      ...
      if (description.includes('G.CO')) {
        return {
          business: {
            id: 'fc8fd6d4-ce92-478e-a64c-cf588024e34f',
            name: 'Google Fi',
          },
      ...
      if (description.includes('ארומה')) {
        return {
          business: {
            id: 'bf354b84-b866-4e7e-af40-50f546a33309',
            name: 'Aroma',
          },
          description: 'Coffee',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('פפואה')) {
        return {
          business: {
            id: 'b62ba5ed-5a45-48aa-95bd-ac2dcbacb685',
            name: 'פפואה',
          },
          description: 'Coffee',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('סופר פארם')) {
        return {
          business: {
            id: '4573516a-df09-4d07-b06b-34fd867829ab',
            name: 'SuperPharm',
          },
      ...
      if (description.includes('חברת פרטנר תקשורת בע')) {
        return {
          business: {
            id: '7ada0a12-39e1-4096-99d2-34c8b3fa0469',
            name: 'Partner',
          },
          tags: [{ name: 'family' }],
        };
      ...
      if (description.includes('העברה מחו"ל') && description.includes('SDI PROCUREMEN')) {
        return {
          business: {
            id: '6390c250-0848-4830-9e09-8444e0a1f360',
            name: 'sdi procurement solutions',
          },
          taxCategory: 'הכנפט1',
          tags: [{ name: 'business' }],
        };
      ...
      if (description.includes('ZOOM')) {
        return {
          business: {
            id: '5ec1b895-3375-4a1f-80d7-894d873723a0',
            name: 'Zoom',
          },
      ...
      if (description.includes('MOUNTAIN V') || description.includes('STORA')) {
        return {
          business: {
            id: '1d3d1427-2a38-4d43-a4ea-90385b0273e2',
            name: 'Google Storage',
          },
      ...
      if (description.includes('APPLE COM BILL/ITUNES.COM')) {
        ...
        return {
          business: {
            id: '6346872a-708d-4910-9428-72019b053ea5',
            name: 'Apple',
          },
          taxCategory: 'אתר',
          beneficiaaries: [], // NOTE: used to be ' '
      ...
      if (description.includes('GETT')) {
        return {
          business: {
            id: '083c6e2e-b4c3-46a7-b918-a00b8d6eae91',
            name: 'Gett',
          },
          description: 'Taxi',
          beneficiaaries: [], // NOTE: used to be ' '
      ...
      if (description.includes('סונול')) {
        return {
          business: {
            id: '0e8f709b-c30c-4575-a228-1d9a5fd7f30e',
            name: 'Sonol',
          },
          description: 'Gas',
          tags: [{ name: 'transportation' }],
      ...
      if (description.includes('אלון')) {
        return {
          business: {
            id: 'f5daf0af-ad40-46d0-94c2-2603f0d20035',
            name: 'Alon',
          },
          description: 'Gas',
          tags: [{ name: 'transportation' }],
      ...
      if (description.includes('קאר 2 גו')) {
        return {
          business: {
            id: 'fbc73635-3b8b-4d40-9d29-0ddf8a999049',
            name: 'קאר 2 גו',
          },
      ...
      if (description.includes('CARPOOL')) {
        return {
          business: {
            id: 'd02e668d-4c13-4fd7-8388-104da05e7ca3',
            name: 'Google Waze',
          },
      ...
      if (description.includes('UBER')) {
        return {
          business: {
            id: '793056f9-df28-44e4-a163-495494a76e3b',
            name: 'Uber',
          },
          description: 'Taxi',
          tags: [{ name: 'transportation' }],
      ...
      if (description.includes('ZAPIER')) {
        return {
          business: {
            id: 'e45f5129-d9f1-4bb7-b3de-01c7110b7d5f',
            name: 'Zapier Inc.',
          },
      ...
      if (description.includes('NOTION')) {
        return {
          business: {
            id: '7b429e58-7d70-4465-a312-4ec60f23303f',
      ...
      if (description.includes('ALTINITY')) {
        return {
          business: {
            id: '492469d7-c071-4b54-b380-a0403ac3db8d',
            name: 'Altinity Inc',
          },
      ...
      if (description.includes('PULUMI')) {
        return {
          business: {
            id: 'b20f4049-cb99-45d6-87bb-19bf700235e0',
      ...
      if (description.includes('קרן מכבי- חיוב')) {
        return {
          business: {
            id: '64d175f5-fbb9-4687-8ef2-96c988e4b72e',
            name: 'Maccabi',
          },
      ...
      if (description.includes('MSFT AZURE')) {
        return {
          business: {
            id: 'a60ccf22-a666-4419-9f69-d84eb2af7e42',
      ...
      if (description.includes('AWS EMEA')) {
        return {
          business: {
            id: '3f153276-8367-47f4-97ea-e92ba4be3e4e',
      ...
      if (description.includes('שיק שיק')) {
        return {
          business: {
            id: '245e149b-b328-471f-9e11-bdaa10dc5fb7',
            name: 'Arye Kristal',
          },
      ...
      if (description.includes('BEEHIIV')) {
        return {
          business: {
            id: '09d5fafa-aca8-470a-925a-45fd9ea6f27c',
            name: 'beehiiv',
          },
      ...
      if (description.includes('POSTMARKAPP')) {
        return {
          business: {
            id: '5a8b588e-4604-4a2b-b209-b86822431a40',
      ...
      if (description.includes('LOOM')) {
        return {
          business: {
            id: 'ce4ab5fe-79e4-463c-904c-5b2fec7be4b2',
            name: 'Loom, Inc',
          },
      ...
      if (description.includes("ג'אסט לאנס")) {
        return {
          business: {
            id: '30a9243d-9f95-4a67-a023-9a965d25c840',
            name: 'JustLance LTD',
          },
          beneficiaries: [
            {
      ...
      if (description.includes('LANCE GLOBAL')) {
        ...
        return {
          business: {
            id: '9c9f3979-08b1-453c-832a-d5eba2bba79a',
            name: 'Lance Global Inc',
          },
      ...
      if (description.includes('CRISP')) {
        return {
          business: {
            id: 'a6b58ace-3f53-4971-8dcf-d606f4a5d367',
            name: 'Crisp IM SARL',
          },
      ...
      if (description.includes('VERCEL')) {
        return {
          business: {
            id: '5b7b0977-2c6f-4b26-93d9-d90c1698edcc',
            name: 'Vercel Inc.',
          },
      ...
      if (description.includes('RETOOL')) {
        return {
          business: {
            id: 'bfe7ba3d-ff20-4f2a-8ece-6aa369b110af',
            name: 'Retool Inc',
          },
          description: 'Retool',
          beneficiaries: [
      ...
      if (description.includes('הוק האוס אוף קופי')) {
        return {
          business: {
            id: 'e11a082f-eda0-4dbf-8ed4-098aea266768',
            name: 'HOC - House Of Coffee',
          },
          description: 'Coffee',
          tags: [{ name: 'food' }],
        };
      ...
      if (description.includes('מנטנטו')) {
        return {
          business: {
            id: '525cf268-0837-4ff2-8af4-3937425b8a27',
      ...
      if (description.includes('משק ברזילי בע"מ')) {
        return {
          business: {
            id: 'fe98bc42-2950-43f4-8a47-4ff6bb15e8a4',
      ...
      if (description.includes('טל יהלום')) {
        return {
          business: {
            id: 'd82782cf-f0ac-412d-b75f-d8c420cb3ff1',
            name: 'Tal Yahalom',
          },
          description: 'gift',
          tags: [{ name: 'family' }],
      ...
      if (description.includes('רוני שפירא')) {
        return {
          business: {
            id: '085bcae7-7e79-4153-be64-a1adb3d7c002',
            name: 'Roney Shapira',
          },
          description: 'gift',
          tags: [{ name: 'family' }],
      ...
      if (description.includes('הלמן-אלדובי') && description.includes('השתלמות')) {
        return {
          business: {
            id: '0117c1b0-c1f3-4564-9bc5-bdc27a8895f0',
            name: 'Halman Aldubi Training Fund',
          },
      ...
      if (description.includes('הלמן-אלדובי') && description.includes('קרן')) {
        return {
          business: {
            id: 'd57ff56d-08ef-454b-88e9-37c4e9d0328c',
            name: 'Halman Aldubi Pension',
          },
      ...
      if (description.includes('PAYPER')) {
        return {
          business: {
            id: '23fd0f9b-01ed-4677-80c3-8d547813a953',
            name: 'Payper',
          },
      ...
      if (
        ...
        return {
          business: {
            id: 'f1749353-979b-46df-8931-93a3aafab1f4',
            name: 'Jelly JS Kamil Kisiela',
          },
      ...
      if (formatAmount(DbCharge.event_amount) == -12_000) {
        ...
        return {
          business: {
            id: 'd140fae3-f841-464c-84a7-c526c0123f36',
      ...
      if (description.includes('Vignesh')) {
        return {
          business: {
            id: 'a07f0014-7b97-4b18-9338-4097dcc9412d',
            name: 'Vignesh T.V.',
          },
          beneficiaries: [
            {
      ...
      if (description.includes('sof0')) {
        return {
          business: {
            id: 'a33448fc-271c-4d20-b6e8-f6245dfadfeb',
            name: 'LaunchMade Web Services',
          },
      ...
      if (description.includes('Steinbock Software LTD')) {
        return {
          business: {
            id: 'd469d98f-e92b-4f9b-882f-767f6a4b4a11',
            name: 'Steinbock Software LTD',
          },
          beneficiaries: [
            {
              counterpartyID: '7843b805-3bb7-4d1c-9219-ff783100334b',
      ...
      if (description.includes('מס הכנסה')) {
        ...
        return {
          ...
          business: flag
            ? {
                id: 'f1ade516-4999-4919-9d94-6b013221536d',
                name: 'Tax Deductions',
              }
            : {
                id: '9d3a8a88-6958-4119-b509-d50a7cdc0744',
                name: 'Tax',
              },
          description: flag
      ...
      if (description.includes('גורניצקי')) {
        ...
        return {
          business: {
            id: 'fe11b834-c218-472b-a129-8ac296553258',
            name: 'Gornitzky & Co., Advocates',
          },
      ...
      if (description.includes('המכס ומעמ-גביי תשלום') || description.includes('CUSTOM + V.A.T')) {
        ...
        return {
          business: {
            id: 'c7fdf6f6-e075-44ee-b251-cbefea366826',
            name: 'VAT',
          },
      ...
      if (description.includes('מטרי')) {
        return {
          business: {
            id: 'a31f1dea-270f-4d32-b47a-68bc55b22ecc',
            name: 'Yaacov Matri',
          },
      ...
      if (description.includes('יפה צדוק')) {
        return {
          business: {
            id: 'd462adc2-6ddc-41a2-93b0-9436387cb90f',
            name: 'Yaffa Tsadoc',
          },
          description: 'Consulting',
          tags: [{ name: 'learn' }],
      ...
      if (description.includes('HEROKU')) {
        return {
          business: {
            id: '5f05b909-bb88-4185-abaa-d3acdbf09808',
            name: 'Heroku',
          },
      ...
      if (description.includes('RAINTANK INC') || description.includes('GRAFANA')) {
        return {
          business: {
            id: '6827bdbd-5176-46b5-aa32-5ece1bf4a0c7',
            name: 'Raintank Inc dba Grafana Labs',
          },
      ...
      if (description.includes('JETBRAINS')) {
        return {
          business: {
            id: 'cbc6a545-d6a3-4f56-96c0-51002454a735',
            name: 'JetBrains',
          },
      ...
      if (description.includes('RESCUETIME')) {
        return {
          business: {
            id: '37c40b38-b000-4ed1-8884-0fa1c7d64e99',
            name: 'RescueTime',
          },
      ...
      if (description.includes('חניון')) {
        return {
          business: description.includes('אחוזות החוף')
            ? {
                id: 'b51aeb4d-48ed-43e5-84a2-f12b6905fd51',
                name: 'Ahuzot',
              }
            : {
                id: 'ed7b54f1-f695-4bc2-b8af-887e3115bfcc',
                name: 'Parking',
              },
          description: 'Parking',
          tags: [{ name: 'transportation' }],
      ...
      if (description.includes('גיא אברהם')) {
        return {
          business: {
            id: '88e77191-0721-40ae-8688-654b3a02b0fd',
            name: 'Guy Avraham LTD',
          },
      ...
      if (description.includes('חשבשבת')) {
        return {
          business: {
            id: '8efb0840-df6f-416d-af66-4953df8d14d5',
            name: 'Hashavshevet',
          },
      ...
      if (description.includes('יהל-מור')) {
        return {
          business: {
            id: 'ba57f515-03ff-40bc-952d-6c701ee6a099',
            name: 'Yahel Mor',
          },
      ...
      if (description.includes('רווה רביד')) {
        return {
          business: {
            id: '61b43877-ece1-4e2f-8f63-ec3cc1a13a43',
            name: 'Raveh Ravid & Co',
          },
      ...
      if (description.includes('GODADDY')) {
        return {
          business: {
            id: 'c71f0cf4-43e4-4567-b646-799ccb72c91c',
            name: 'GoDaddy',
          },
          description: 'Domain',
          tags: [{ name: 'business' }],
      ...
      if (description.includes('AHREFS')) {
        return {
          business: {
            id: 'a7a93796-0b53-41cf-8f9d-c0d11ee8eb24',
            name: 'Ahrefs Pte. Ltd.',
          },
      ...
      if (description.includes('DALET DIGITAL')) {
        return {
          business: {
            id: 'a3f4985e-1164-4a20-b9d5-b4169c47ead3',
            name: 'Dalet Digital Media Systems USA Inc',
          },
      ...
      if (description.includes('ETANA')) {
        ...
        return {
          business: {
            id: '73519067-c8fe-4073-aec6-608ff596f8a8',
      ...
      if (description.includes('OUTREACH')) {
        return {
          business: {
            id: 'cab41f1c-157d-4535-be70-21167fd4edc0',
            name: 'Outreach Corporation',
          },
      ...
      if (description.includes('ard')) {
        return {
          business: {
            id: '8125698d-de35-4e0a-8896-fccc57c13a69',
            name: 'Arda Tanrikulu',
          },
      ...
      if (description.includes('deel')) {
        ...
        return {
          business: {
            id: '8d34f668-7233-4ce3-9c9c-82550b0839ff',
            name: 'Deel Germany GmbH',
          },
      ...
      if (description.includes('עידן')) {
        return {
          business: {
            id: '0954cf17-4741-4354-bc38-ceee6364e598',
            name: 'Idan Am-Shalem',
          },
          tags: [{ name: 'business' }],
          beneficiaries: [
      ...
      if (description.includes('מועדון הבלוק')) {
        return {
          business: {
            id: 'd2c0045b-95f9-41de-9008-255e8793007e',
            name: 'The Block',
          },
          description: 'Party',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('chillz')) {
        return {
          business: {
            id: 'ebfd52d3-f38e-4a59-8c42-7f831f3046ed',
            name: 'chillz',
          },
          description: 'Party',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('EVENTBUZZ TICKETS') || description.includes('איבנטבאז')) {
        return {
          business: {
            id: '8d5141fd-5f5f-48f8-98f4-095e4889e278',
            name: 'EVENTBUZZ TICKETS',
          },
          description: 'Party',
          tags: [{ name: 'fun' }],
        };
      ...
      if (description.includes('סלון ברלין')) {
        return {
          business: {
            id: 'e5fff596-d62a-4b2d-961c-e8b5f86a0da9',
            name: 'סלון ברלין',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('סילון')) {
        return {
          business: {
            id: '334c8245-e915-4beb-a613-97ac530790cf',
            name: 'סילון',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('גוגיס')) {
        return {
          business: {
            id: '13cd79fb-ed3c-458a-b6d0-5b08cc7834d4',
            name: 'גוגיס',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('אלברט 1943')) {
        return {
          business: {
            id: 'e5bf3640-4308-41d4-982c-053c99a87b02',
            name: 'אלברט 1943',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('223')) {
        return {
          business: {
            id: 'bb34dbcc-16e2-4da0-b531-ed7c05fbc3a4',
            name: '223 Bar',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('רמפה')) {
        return {
          business: {
            id: 'db3b05dd-a444-480a-9ec4-9f06bde047c8',
            name: 'Ala Rampa',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('K-BAR')) {
        return {
          business: {
            id: '170f75e0-2c4d-438e-9729-39553cf453e9',
            name: 'K BAR',
          },
          description: 'Bar',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('NETFLIX')) {
        return {
          business: {
            id: 'cdf7b1f2-366f-4fcb-9f84-910a5bf741d8',
            name: 'Netflix',
          },
          description: 'TV',
          tags: [{ name: 'fun' }],
      ...
      if (description.includes('תורגמן יצחק ואברהם')) {
        return {
          business: {
            id: 'fd308f3a-2bb0-468e-8243-f362ac072957',
            name: 'תורגמן יצחק ואברהם',
          },
          description: 'טמבוריה',
          tags: [{ name: 'house' }],
        };
      ...
      if (description.includes('קאופמן מנעולים')) {
        return {
          business: {
            id: '567191ed-4e55-4fcb-ba14-ba98e35ddbc3',
            name: 'קאופמן מנעולים',
          },
          description: 'טמבוריה',
          tags: [{ name: 'house' }],
      ...
      if (description.includes("חב' חשמל דן חשבונות")) {
        return {
          business: {
            id: '9bf2a192-a31f-4b13-9cb7-ffb6e9430be1',
      ...
      if (description.includes('עיריית תל אביב יפו א')) {
        return {
          business: {
            id: '22eec5bb-88a7-4513-a3f6-b73da21e9111',
      ...
      if (description.includes('EUFYLIFE')) {
        return {
          business: {
            id: 'c4bc6172-8fff-4c01-bc45-6a7b38020311',
            name: 'Eufy',
          },
      ...
      if (description.includes('NAME COM')) {
        return {
          business: {
            id: '4cfc08d5-a4c3-4d12-8a63-b4cadc9d7061',
            name: 'NAME COM',
          },
          description: 'Domain',
          tags: [{ name: 'business' }],
      ...
      if (description.includes('SENTRY')) {
        return {
          business: {
            id: '80690926-5f4e-4a37-947b-92a66b699956',
            name: 'Sentry',
          },
      ...
      if (description.includes('RENDER')) {
        return {
          business: {
            id: '06f222ab-d304-4610-b51a-1dd9132ef6df',
            name: 'Render',
          },
          description: 'Hosting',
          tags: [{ name: 'business' }],
      ...
      if (description.includes('ELASTIC')) {
        return {
          business: {
            id: '13e86132-f2c5-482f-b3f7-e99d14d4e38c',
      ...
      if (description.includes('GSUITE') || description.includes('GOOGLE CLOUD')) {
        return {
          business: {
            id: 'f989d32b-089f-4418-9966-fbb478576fbe',
      ...
      if (description.includes('רב-פס')) {
        return {
          business: {
            id: 'dff879e8-cafd-4ca1-af4c-d1d9974e50f0',
            name: 'רב-פס',
          },
      ...
      if (description.includes('קיוסק קקל')) {
        return {
          business: {
            id: 'd5d02140-9e09-4a49-82d0-3be6983794bf',
            name: 'לה קפה',
          },
          description: 'Coffeee',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('ספסל בן גוריון')) {
        return {
          business: {
            id: '3cf7f0de-3f50-4571-b917-a9dd8a181213',
            name: 'ספסל בן גוריון',
          },
          description: 'Coffee',
          tags: [{ name: 'food' }],
      ...
      if (description.includes('גולדשטיין בן_עמי')) {
        return {
          business: {
            id: '64914e5c-533f-4175-bad5-bc2c01a21277',
            name: 'Benami Goldshtein',
          },
      ...
      if (description.includes('CALENDLY')) {
        return {
          business: {
            id: '3188b1eb-ae3a-4218-8f85-b05b4aed9b51',
            name: 'Calendly LLC',
          },
      ...
      if (description.includes('קיי אס פי מחשבים')) {
        return {
          business: {
            id: 'a1e47b67-9693-40b0-a2d1-61c1ecbc4030',
            name: 'KSP',
          },
      ...
      if (formatAmount(DbCharge.event_amount) == -600) {
        return {
          business: {
            id: '02d467c9-0818-45e3-9a25-9f99d0101a9e',
            name: 'ZAUM',
          },
