...
LEFT JOIN (SELECT id,
    (COALESCE(poalim_ils_id::TEXT, poalim_eur_id::TEXT, poalim_gbp_id::TEXT, poalim_swift_id::TEXT, poalim_usd_id::TEXT, creditcard_id::TEXT, kraken_id, etana_id, etherscan_id)) AS source_id
