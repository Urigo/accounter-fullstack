...
import { DocumentsInvoiceQuery, InvoiceFieldsFragment, Proforma, ProformaFieldsFragment, useDocumentsInvoiceQuery, useDocumentsProformaQuery } from '../../__generated__/types';
